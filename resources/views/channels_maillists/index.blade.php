...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Channels Maillists</h4>
            </div>
        ...
        @if(count($channelsMaillists) == 0)
            <div class="panel-body text-center">
                <h4>No Channels Maillists Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($channelsMaillists as $channelsMaillist)
                        <tr>
                            <td>{{ $channelsMaillist->maillist }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('channels_maillists.channels_maillist.show', $channelsMaillist->channel_id ) }}" class="btn btn-info" title="Show Channels Maillist">
