...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Evenotifs</h4>
            </div>
        ...
        @if(count($evenotifsObjects) == 0)
            <div class="panel-body text-center">
                <h4>No Evenotifs Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($evenotifsObjects as $evenotifs)
                        <tr>
                            <td>{{ optional($evenotifs->sender)->id }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('evenotifs.evenotifs.show', $evenotifs->notification_id ) }}" class="btn btn-info" title="Show Evenotifs">
